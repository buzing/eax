...
void callbacks::ConfigLoad1( ) {
	g_config.load( &g_menu.main, XOR( "1.eax" ) );
...
void callbacks::ConfigLoad( ) {
	...
	std::string file   = tfm::format( XOR( "%s.eax" ), config.data( ) );
